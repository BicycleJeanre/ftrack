...
async function runGoalBasedWorkflowTest() {
  const workflowName = 'Goal-Based';
...
if (require.main === module) {
  runGoalBasedWorkflowTest().catch((error) => {
    console.error('[QC][Goal-Based] Fatal error:', error);
    process.exit(1);
  });
}

module.exports = {
  runGoalBasedWorkflowTest
};
