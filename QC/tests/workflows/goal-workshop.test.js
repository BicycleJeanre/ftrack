...
async function runGoalWorkshopWorkflowTest() {
  const workflowName = 'Goal Workshop';
...
if (require.main === module) {
  runGoalWorkshopWorkflowTest().catch((error) => {
    console.error('[QC][Goal Workshop] Fatal error:', error);
    process.exit(1);
  });
}

module.exports = {
  runGoalWorkshopWorkflowTest
};
