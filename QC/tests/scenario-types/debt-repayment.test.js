...
async function runDebtRepaymentScenarioTypeTest() {
  const scenarioType = 'Debt Repayment';
...
if (require.main === module) {
  runDebtRepaymentScenarioTypeTest().catch((error) => {
    console.error('[QC][Debt Repayment] Fatal error:', error);
    process.exit(1);
  });
}

module.exports = {
  runDebtRepaymentScenarioTypeTest
};
