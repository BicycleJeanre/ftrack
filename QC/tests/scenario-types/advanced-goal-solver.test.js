...
async function runAdvancedGoalSolverScenarioTypeTest() {
  const scenarioType = 'Advanced Goal Solver';
...
if (require.main === module) {
  runAdvancedGoalSolverScenarioTypeTest().catch((error) => {
...
module.exports = {
  runAdvancedGoalSolverScenarioTypeTest
};
