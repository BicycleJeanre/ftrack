...
async function runFundsScenarioTypeTest() {
  const scenarioType = 'Funds';
...
if (require.main === module) {
  runFundsScenarioTypeTest().catch((error) => {
    console.error('[QC][Funds] Fatal error:', error);
    process.exit(1);
  });
}

module.exports = {
  runFundsScenarioTypeTest
};
