...
async function handler(req, res) {
    if (req.method === 'POST') {
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["query"])(`CREATE DATABASE ${dbName}`);
            res.status(200).json({
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["query"])(`DROP DATABASE ${dbName}`);
            res.status(200).json({
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["query"])('SELECT datname FROM pg_database WHERE datistemplate = false;');
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d520f8._.js.map